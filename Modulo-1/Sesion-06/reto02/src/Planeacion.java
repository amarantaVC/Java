...
public class Planeacion {
    public static void main(String[] args) {
        ...
        System.out.println("Listado de temas ordenados por orden alfabético:");
        for (Tema t : temas) {
            System.out.println(t);
        }

        // Se ordenan los temas por prioridad usando Comparator
        ...
        System.out.println("\nListado de temas ordenados por prioridad (1 = urgente):");
        for (Tema t : temas) {
            System.out.println(t);
        }
        ...
        // Se muestra el repositorio de recursos por tema
